...
const palavras = ["ç","um","sim","vixe","outro","quinze",""]; // A lista de palavras que o jogo pode escolher aleatoriamente
...
let tentativas = 42; // O número de tentativas iniciais do jogador
...
function escolherPalavra() {
    ...
    tentativas = 42; // Reinicia as tentativas para 42
